...
This appendix provides detailed test vectors to ease implementation and ensure interoperability. The test vectors in this version are compatible with versions -05 and -06 of the specification.
